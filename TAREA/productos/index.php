...
<section class="listaResultados">
    <div class = "contenedor" id="contenedor">
        ...
        $sql = "select * from giovanni_producto";

        $rs = ejecutar($sql);
        $k = 1;
        while ($datos = mysqli_fetch_array($rs)){
            if ($k % 2 == 0){
                echo '<div class="claro">'.$datos["productos"].'</div>';
                ...
                $sql2 = "select foto from giovanni_fotoProductos where idProducto = ".$datos["idProducto"];
                $rs2 = ejecutar($sql2);
                ...
                echo '<div class="oscuro">'.$datos["productos"].'</div>';
...
<div class="modal" id="vModal">
    <div class="modal-bg">
        ...
        <div class="modal-container">
            <div class="cerrar">
            <button type="button" onClick="cerrarModal()"><i class="fas fa-times-circle"></i></button>
        </div>
        <div class="titulo">Producto Nuevo</div>
        <div class="iconos"><i class="fas fa-user-astronaut"></i></div>
            <div class="formularioModal"><input type="text" placeholder="Nombre producto" name="productos" class="camposModal" id="c1"/></div>

            <div class="iconos"><i class="fas fa-book-open"></i></div>
            <div class="formularioModal"><textarea name="descripcion" rows="5" cols="40"></textarea></div>

            <div class="iconos"><i class="fas fa-money-bill-alt"></i></div>
            <div class="formularioModal"><input type="text" placeholder="Precio producto" name="precio" class="camposModal" id="c2"/></div>

            <div class="iconos"><i class="fas fa-camera"></i></div>
